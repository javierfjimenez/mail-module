...
$(function () {
    ...
    if (dtUserTable.length) {
        // console.log();
        $.get(window.location.origin + "/api/contacts", (data, status) => {
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            ...
                            return (
                                ...
                                'Details</a>' +
                                '<a onclick="remove('+$id+')" href="javascript:;" class="dropdown-item delete-record">' +
                    ...
                    details: {
                        ...
                        renderer: function (api, rowIdx, columns) {
                            var data = $.map(columns, function (col, i) {
                                return col.columnIndex !== 3 // ? Do not show row in modal popup if title is blank (for check box)
                                    ? '<tr data-dt-row="' +
                                          col.rowIdx +
                                          '" data-dt-column="' +
                                          col.columnIndex +
